function solve() {
    ...
    const openSection = sections[0].getElementsByTagName('div').item(1);
    const inProgressSection = sections[1].getElementsByTagName('div').item(1);
    const completeSection = sections[2].getElementsByTagName('div').item(1);
    ...
    function addTask(e) {
        ...
        const btnDiv = createElement('div', [startBtn, deleteBtn], { className: 'flex' });
