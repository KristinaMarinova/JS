function studentsDB() {
    ...
    async function addStudent(e) {
        ...
        await sendRequest(`https://softuni-tests-bfd33.firebaseio.com/students.json`, 'POST', newStudent);
        loadData();
    }

    async function loadData() {
        table.innerHTML = '';
        let data = await sendRequest(`https://softuni-tests-bfd33.firebaseio.com/students.json`, 'GET');
